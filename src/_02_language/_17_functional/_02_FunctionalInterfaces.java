...
- These interfaces operate directly on primitive values, avoiding boxing and unboxing overhead present with generic
  functional interfaces.
- They are commonly used with primitive streams (IntStream, LongStream, DoubleStream) and in performance-sensitive code
  where numerical operations are frequent.
