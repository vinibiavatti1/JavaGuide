...
/*
Since Java 25, it is possible to use a simplified top-level main method without explicitly defining a class, but the
traditional form below remains the standard and is widely used.
*/
void main() {
    IO.println("Hello World"); // Output: Hello World
}