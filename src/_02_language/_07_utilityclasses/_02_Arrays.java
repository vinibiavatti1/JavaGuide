...
- It contains static utility methods for array manipulation, comparison, hashing, string representation, and
  stream creation.
- Introduced in early Java versions and continuously expanded, including enhancements for parallel operations in Java 8.
...
void main() {
    ...
    */
    ...
    - Supports optional range parameters and a custom comparator for flexible behavior.
    - The "Arrays.parallelSort()" method can be used to improve performance dividing the work across multiple threads.
    - Output: [1, 2, 3]
    */
    ...
    */
    ...
    - The "Arrays.parallelSetAll()" method can be used to improve performance dividing the work across multiple threads.
    - Output: [0, 2, 4]
    */
    intArray = new int[3];
    ...
    */
    ...
    - Returns a negative integer, zero, or a positive integer if the first array is less than, equal to, or greater than
      the second array.
