...
void main() {
     ...
     * - Avoid underscores, special symbols, and spaces.
     * - Keep names concise and meaningful.
     * - Prefer a naming style that indicates expected outcome (shouldReturnTrueWhenValid
     ...
     * - Use unchecked exceptions for programming errors or unexpected conditions that the caller cannot reasonably
     *   recover.
     */
