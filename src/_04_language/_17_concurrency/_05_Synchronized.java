...
Overview
- "synchronized" controls concurrent access to code sections, ensuring only one thread at a time executes a synchronized
  method or block associated with the same monitor.
