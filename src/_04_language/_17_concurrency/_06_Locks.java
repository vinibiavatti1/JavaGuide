 ...
 * - Introduced in Java 5 as part of the concurrency utilities to enhance thread-safety and control over critical
 *   sections.
 *
 * Key Characteristics
 ...
 * - Useful in concurrent applications, high-performance code, and situations where synchronized blocks may be too
 *   rigid.
 *
 * Example
