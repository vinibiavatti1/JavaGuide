...
void main() {
     ...
     * - The "getAndSet(newValue)" method can be used to atomically replace the current value with a new one and return
     *   the old value.
     * - Output: 5
     */
     ...
     * - The "getAndIncrement()" method also increases the value by 1 but returns the previous value before
     *   incrementing.
     * - Output: 6
     */
    atomicInteger = new AtomicInteger(5);
    ...
    /*
     * Add
     * - The "addAndGet()" method adds the specified value to the current value and returns the updated result
     *   atomically.
