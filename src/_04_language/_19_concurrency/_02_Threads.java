 ...
 *   threads.
 * - User threads keep the JVM alive until completion, while daemon threads terminate automatically when all user
 *   threads finish.
...
void main() throws InterruptedException {
     ...
     * - Creates a daemon thread by passing a Runnable task (Task) to the Thread constructor and calling
     *   "setDaemon(true)".
     * - Daemon threads run in the background and do not prevent the JVM from exiting once all user threads have
     *   finished.
