 ...
 * - UDP Datagrams are suitable for applications that prioritize low latency and high performance, where occasional
 *   packet loss is acceptable, such as online games, video/audio streaming, VoIP, and broadcast/multicast protocols.
 ...
 * - Each message is sent as a discrete packet; the application is responsible for handling lost or out-of-order
 *   packets.
