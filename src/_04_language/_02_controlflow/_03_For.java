 ...
 * - The "for-each" loop (enhanced for loop) iterates over all elements of an array or Iterable without requiring an
 *   index.
 *
 * Key Characteristics
...
void main() {
     ...
     * - The loop executes the code block while the condition evaluates to true, updating variables as specified after
     *   each iteration.
     * - Output: 0 | 1 | 2
     */
    for (int i = 0; i < 3; i++) {
     ...
     * - To prevent the program from hanging, an explicit exit condition or a break statement should be included inside
     *   the loop.
     */
    for (;;) {
        break;
