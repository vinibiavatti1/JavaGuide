...
void main() {
    ...
    - The "if" statement evaluates a boolean expression and executes the associated code block only when the condition
      is true.
    ...
    */
    ...
    - Although valid, this style should be used with caution, as it can reduce readability and lead to errors when the
      code is later modified.
    - Output: x is positive
    */
    x = 1;
