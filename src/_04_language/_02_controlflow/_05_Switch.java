...
void main() {
     ...
     * - The switch statement allows a program to select one execution path from multiple options based on the value of
     *   an expression.
     ...
     * - In a switch expression, the default case is required unless all possible values of the expression are
     *   explicitly covered.
     * - Output: Error
     */
    httpStatus = 500;
     ...
     * - This switch statement uses pattern matching combined with guards and is used as an expression, allowing the
     *   result of the switch to be assigned directly to a variable.
