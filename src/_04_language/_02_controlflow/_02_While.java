...
void main() {
     ...
     * - The condition is checked before each iteration, meaning the loop may execute zero or more times depending on
     *   the initial state.
     * - Output: 0 | 1 | 2
     */
    int i = 0;
     ...
     * - Infinite loops are often used in scenarios that require continuous processing, such as servers or event
     *   listeners, but care must be taken to include a proper exit condition or break statement to avoid unintentional
     *   application hangs.
     */
    while (true) {
        break;
     ...
     * - The do-while loop executes a block of code at least once before checking the condition at the end of the loop.
     * - The loop will continue executing as long as the condition evaluates to true.
     * - Output: 0 | 1 | 2
     */
    i = 0;
    do {
