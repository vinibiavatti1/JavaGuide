...
void main() {
    /*
     * Declare Array at Runtime
     * - The "Array.newInstance()" method creates a new array of the specified type and length at runtime using
     *   reflection.
     ...
     * - For primitive arrays, specialized methods like Array.setInt, Array.setDouble, etc., can be used to avoid
     *   boxing.
     ...
     * - For primitive arrays, specialized methods like Array.getInt, Array.getDouble, etc., can be used to avoid
     *   unboxing.
