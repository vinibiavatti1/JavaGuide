...
void main() throws Exception {
     ...
     * - For generic classes, the type parameter is not enforced at runtime due to type erasure; the returned object
     ...
     * - Use "newInstance()" to create a new instance dynamically; arguments must match the constructor's parameter
     *   types.
