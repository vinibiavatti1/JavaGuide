...
- InvocationHandler is a functional interface with a single method `invoke(Object proxy, Method method, Object[] args)`.
...
Example
- This example demonstrates how to create a proxy for an interface, define dynamic behavior via an invocation handler,
  and intercept method calls at runtime.
*/
