...
- The most commonly used meta-annotations include:
  ...
  - @Target: Specifies the program elements where the annotation can be applied (e.g., TYPE, METHOD, FIELD, PARAMETER).
...
void main() throws Exception {
    ...
    - Class-level annotations are commonly used to attach metadata that describes behavior, configuration, or semantic
