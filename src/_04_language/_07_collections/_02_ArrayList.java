...
void main() {
     ...
     * - Use this approach when you need an initial set of elements but want to modify the list dynamically during
     *   program execution.
     * - Output: [A, B, C]
     */
    ...
    /*
     * Getting Last Index
     * - The "lastIndexOf(Object o)" method returns the index of the last occurrence of the specified element in the
     *   list.
     * - If the element is not found, it returns -1.
     * - Output: 2
     */
    ...
    /*
     * Adding Elements
     * - Elements can be added to a List dynamically using the "add()" method. The list automatically resizes as needed
     *   to accommodate new elements.
     * - This approach is suitable for mutable lists where elements are not known in advance or may change during
     *   program execution.
     ...
     * - The "remove(Object o)" method removes the first occurrence of the specified element from the list, if it
     *   exists.
     ...
     * - In addition to navigation, it supports modifying the list during iteration, such as adding, removing, or
     *   replacing elements, and provides access to the current element index.
     * - Output: 0:A | 1:B | 2:C
     */
    list = List.of("A", "B", "C");
    ...
    /*
     * Functional Replace
     * - The "replaceAll()" method applies a transformation function to each element of the list and replaces the
     *   original elements with the results.
