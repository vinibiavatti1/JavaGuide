...
- This section explains file-based input and output in Java, focusing exclusively on reading and writing data from the
  filesystem using the modern java.nio.file.Files API.
...
- General stream concepts (byte vs character streams, buffering, decorators) are covered separately in DataStreams.java.
