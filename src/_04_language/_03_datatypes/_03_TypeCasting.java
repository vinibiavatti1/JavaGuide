/*
Type Casting
- This section explains type casting in Java, which is the process of converting a value from one data type to another
  using the cast operator: (targetType) value.
