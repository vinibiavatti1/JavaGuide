...
void main() {
    ...
    /*
     * Min and Max Values
     * - To retrieve the min and max values of numeric wrapper types, we can use the fields available in the wrapper
     *   class.
     */
     ...
     * - Floating-point wrapper classes provide useful predefined constants, such as NaN (Not a Number), positive
