 ...
 *   types: IntStream, LongStream, and DoubleStream. These streams avoid boxing overhead, improving performance for
 *   numeric processing.
 *
 * Overview
...
void main() {
     ...
     * - Useful for performing numeric operations like sum, average, min, max, or other reductions without boxing
     *   overhead.
