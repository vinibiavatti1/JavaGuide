...
void main() throws IOException {
     ...
     * - The first argument is the prefix of the file name, and the second argument is the suffix (usually an
     *   extension).
     ...
     * - The "Files.createTempDirectory" method creates a new temporary directory in the default temporary-file
     *   directory.
     * - The argument is used as a prefix for the directory name, which is made unique automatically to avoid
     *   collisions.
     ...
     * - If the target file already exists, a FileAlreadyExistsException is thrown unless you specify the
     ...
     * - Methods to override:
     *   - visitFile: Invoked for each file encountered during the traversal.
     *   - preVisitDirectory: Invoked before entering a directory.
     *   - postVisitDirectory: Invoked after all entries in a directory have been processed.
     *   - visitFileFailed: Invoked when a file cannot be accessed or visited.
     ...
     * - Output: Visiting: resources\file.dat | Visiting: resources\file.txt
     */
