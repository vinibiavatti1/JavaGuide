...
void main() {
    ...
    /*
     * Then Accept Both
     * - The "thenAcceptBoth" method allows you to perform an action using the results of two CompletableFutures once
     *   both have completed.
     ...
     * - The "exceptionallyCompose" method allows you to handle exceptions by returning a new CompletableFuture,
     *   enabling asynchronous recovery from errors.
     * - Useful when you want to continue the computation asynchronously after an exception occurs, instead of providing
     *   a simple fallback value.
