/*
 * Semaphore
 * - This section explains the "Semaphore" class in Java, which provides a mechanism to control access to shared
 *   resources by multiple threads through a limited number of permits.
 *
 * Overview
 ...
 * - Useful in concurrent applications where fine-grained access control is required beyond simple synchronized blocks
 *   or locks.
 *
 * Example
