/*
Generics
- This section explains Java generics, a language feature that allows classes, methods, and fields to operate on objects
  of various types while providing compile-time type safety.

Overview
- Generics provide a way to define type parameters (e.g., <T>, <E>, <K, V>) that are specified when the class or method 
  is instantiated or called.
