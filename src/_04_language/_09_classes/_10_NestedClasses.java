 ...
 *   - Static Nested Classes: behave like top-level classes but scoped within the outer class; do not have a reference
 *     to the outer instance.
 *   - Inner Classes: non-static, associated with an instance of the outer class; can access outer class members
 *     directly.
 ...
 *     implementations.
 * - Nested classes are less commonly used in everyday programming, but are useful for small helper classes and
 *   situations requiring encapsulation within a containing class.
 ...
 * - Inner, local, and anonymous classes are useful for maintaining encapsulation while providing access to the outer
 *   class context.
...
void main() {
     ...
     * - Instantiates a non-static inner class, which requires a reference to an existing instance of the enclosing
     *   outer class.
