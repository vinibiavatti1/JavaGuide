/*
 * Exception Methods
 * - This section explains the methods provided by the "Throwable" class (and inherited by Exception and
 *   RuntimeException) to inspect, manipulate, and handle exceptions in Java.
 *
 * Overview
 * - Throwable provides methods to get information about the exception, its cause, stack trace, and suppressed
 *   exceptions.
...
void main() {
     ...
     * - The exception below will be declared to demonstrate the available methods and operations.
     * - Output: java.lang.Exception: Something Happened!
     */
    Exception e = new Exception("Something Happened!");
    IO.println(e);
