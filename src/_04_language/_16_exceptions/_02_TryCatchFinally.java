/*
 * Try-Catch-Finally
 * - This section explains how to use try-catch-finally blocks in Java to handle exceptions, ensuring proper error
 ...
 *
 * Example
 * - A method will be declared below that throws a NullPointerException and a ArithmeticException depending on the value
 *   of the arguments.
...
void main() {
     ...
     * - The first catch block handles ArithmeticException, and the second catch block handles any other exceptions,
     ...
     * - Demonstrates using multiple catch blocks to handle different exceptions, and a finally block that always
     *   executes.
