/*
 * Collections
 * - This section explains the "Collections" utility class in Java, which provides static methods to operate on
 *   Collection instances, including creating special-purpose collections, searching, sorting, synchronizing, etc.
 *
 * Overview
 ...
 *   statistics.
 * - Apply when you need consistent behavior across different Collection types or want to leverage built-in utility
...
void main() {
     ...
     * - Similar unmodifiable wrappers exist for other collection types, such as unmodifiableSet() and
     *   unmodifiableMap().
     * - Output: [A, B, C]
     */
     ...
     * - Similar synchronized wrappers exist for other collection types, such as synchronizedSet() and
     *   synchronizedMap().
     * - Output: [A, B, C]
     */
    list = new ArrayList<>(List.of("A", "B", "C"));
    ...
    /*
     * Replace All
     * - The "Collections.replaceAll" method replaces all occurrences of a specified element in a list with a new
     *   element.
