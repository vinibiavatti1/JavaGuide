...
void main() {
     ...
     * - The "Objects.checkFromToIndex" method validates a range defined by fromIndex (inclusive) and toIndex
     *   (exclusive).
     ...
     * - Returns a negative integer, zero, or a positive integer if the first argument is less than, equal to, or
