/*
Lifecycle
- This document explains the Java application lifecycle, covering how source code is compiled into bytecode and how that
  bytecode is executed by the JVM, from development to runtime.

Overview
- Java applications follow a two-step lifecycle: compilation and execution.
- Source code written in ".java" files is first compiled into platform-independent bytecode (".class" files) by the Java
  compiler (javac).
