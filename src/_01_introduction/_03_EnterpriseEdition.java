 ...
 * - This document focuses on the Java Enterprise platform, its enterprise-specific responsibilities, runtime model,
 *   core specifications, application servers, and its role in modern enterprise architectures.
 *
 * Overview
 ...
 *     - EJB (Enterprise Java Beans): transactional business components, timers, remoting (historical but still
 *       relevant)
